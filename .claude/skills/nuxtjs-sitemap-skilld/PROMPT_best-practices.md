Generate SKILL.md section for "@nuxtjs/sitemap" v8.0.6.
...
- `./references/docs/content/1.guides/` (9 .md files)
- `./references/docs/content/2.advanced/` (5 .md files)
- `./references/docs/content/4.api/` (2 .md files)
- `./references/docs/content/5.nitro-api/` (1 .md files)
- `./references/docs/content/5.releases/` (6 .md files)
- `./references/pkg/` (2 .md files)
- `./references/pkg-sitemap/` (2 .md files)
- `./references/pkg-sitemap/node_modules/std-env/` (1 .md files)
- `./references/pkg/node_modules/std-env/` (1 .md files)
</external-docs>
...
Skip: obvious API usage, installation steps, general TypeScript/programming patterns not specific to this package, anything a developer would naturally write without reading the docs. Every item must be specific to @nuxtjs/sitemap — reject general programming advice that applies to any project.

Search: `skilld search "recommended" -p @nuxtjs/sitemap`, `skilld search "avoid" -p @nuxtjs/sitemap`

## Format

<format-example note="Illustrative structure only — replace placeholder names with real @nuxtjs/sitemap APIs">
```
## Best Practices

- Use @nuxtjs/sitemap's built-in `createX()`./references/docs/api.md#createx)
