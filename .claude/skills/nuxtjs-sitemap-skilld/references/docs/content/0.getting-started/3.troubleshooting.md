...
This is a browser bug in parsing the `xhtml` namespace which is required to add localised URLs to your sitemap.
...
If your sitemap is validating correctly, then you're all set.
