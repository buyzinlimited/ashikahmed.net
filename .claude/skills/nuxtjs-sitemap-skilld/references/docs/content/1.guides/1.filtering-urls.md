...
If you just have some specific pages, you can use the experimental `defineRouteRules()`{lang="ts"}, which must
be enabled.
...
Providing strings will use the route rules path matching which
