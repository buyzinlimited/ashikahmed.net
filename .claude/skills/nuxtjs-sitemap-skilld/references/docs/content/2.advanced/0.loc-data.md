...
Alternatively, you can use the experimental macro `defineRouteRules()`{lang="ts"}, which must
be enabled.
...
You can configure sitemap entry data directly in your page components using `definePageMeta()`{lang="ts"}.
